...
export default class PhongShader extends Shader {
    constructor(gl, material) {
        ...
        this.uniformLocations.fogColor = gl.getUniformLocation(this.program, "fogColor");
        this.uniformLocations.minFogDistance = gl.getUniformLocation(this.program, "minFogDistance");
        this.uniformLocations.maxFogDistance = gl.getUniformLocation(this.program, "maxFogDistance");
